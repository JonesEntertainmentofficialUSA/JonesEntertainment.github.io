...
if %num% == 2 goto CARD_BATTLE_Demo
...
if %CardNumberA% == 1 set CardClassA=S
if %CardNumberA% == 1 set CardNameA=Blaster
if %CardNumberA% == 1 set CardDescA=A giant blast! [200DMG]
if %CardNumberA% == 1 set CardDmgA=200
::
if %CardNumberB% == 2 set CardClassB=S 
if %CardNumberB% == 2 set CardNameB=Recover
if %CardNumberB% == 2 set CardDescB=Heal HP.
if %CardNumberB% == 2 set CardB_set=500
::
if %CardNumberC% == 3 set CardClassC=G
if %CardNumberC% == 3 set CardNameC=Delta Max
if %CardNumberC% == 3 set CardDescC=(2hit) - 300
if %CardNumberC% == 3 set CardDmgC=300*2
echo                ENERGY CARD           
echo ===================================================
...
ping localhost -n 1 >nul
color F0
if %CardNumberA% == 1 @set /A "enemy1HP=%enemy1HP%-%CardA_set%" 
if %CardNumberA% == 1 goto battle_Kapus_AreaDesc
...
::Checks if cutscene was played or not.
...
if %num% == 2 goto CARD_BATTLE_Demo
if %num% == 3 goto Special_Battle_1
if %num% == q goto dodge_pannel_Player_left_Demo
...
color F0
if %CardNumberA% == 1 @set /A "enemy1HP=%enemy1HP%-%CardA_set%" 
if %CardNumberA% == 1 goto battle_Kapus_AreaDesc_Demo
if %CardNumberB% == 2 goto HP_Recovery_CARD002
::add enemy turn! (Replace this goto command.)


:HP_Recovery_CARD002_Demo
::If the HP is Higher than the max HP, the recovered amount of HP will swap to MAX HP amount, if over shot.
@set /A "HP=%HP%+500"
if %HP% GEQ %MAXHP% set HP=%MAXHP% 
goto Area1_Battle_ScoreBot_BATTLE_DEMO
