...
goto VAR0
::---------------------------------------------------------------------::
::Game engine - Customly made through batch.                           ::
::Using CMD to run.                                                    ::
::All images processed through CHCP command. (Unicode)                 ::
::                                                                     ::
::Can only run through windows, unless you use a coversion tool online.::
::(Windows 11 - Windows Batch file (.bat))                             ::
::---------------------------------------------------------------------::


:Error_found
cls 
echo                 ERROR CODE %random%
echo                ██████████████████████████████████████
echo                █ There was a problem found within   █
echo                █ the code. Please try again.        █
echo                ██████████████████████████████████████
pause >nul
goto titleScreen

::------------------------------------------------------------------------------::
::The "true" or "false" variables that are similar to Boolean variables, instead:: 
::of true and false it is just "YES" and "NO".                                  ::
::------------------------------------------------------------------------------::
:SWITCHES
set SW1=NO
set SW2=NO 
...
::------------------------------------::
::Status at the beginning of the game.::
::------------------------------------::
:VAR0
cls                       
set lv=1
...
:VAR4
::--------------------------------------------------------::
::Skill names and locks them at the beginning of the game.::
::--------------------------------------------------------::
...
if %num% == 4 goto Amount_I4
if %num% == 5 goto Amount_I5
if %num% == c goto Menu
::
:Amount_I1
...
if %ITEM1% == 0 goto NotEnough
:Amount_I4
if not %ITEM4% == 0 goto Absorb_I4
if %ITEM4% == 0 goto NotEnough
:Amount_I5
if not %ITEM5% == 0 goto Absorb_I5
if %ITEM5% == 0 goto NotEnough
:Absorb_I1
...
goto item 
:Absorb_I5
if %DUNGEON.SW1% == YES goto re;location
if not %DUNGEON.SW1% == YES goto locator
else (
    goto Error_Found
)
:HP_CHANGE
...
echo.
set /p num=
if %num% == 1 goto sound_checker
if %num% == 2 goto save-files_checker
if %num% == 3 goto error_checker
if %num% == x goto titleScreen 
...
if %random% GEQ %random% goto Run_away
::------------------------------------------------------------------------------------------::
::The run away label was made to reset the random encounter rate, when the player runs away.::
::------------------------------------------------------------------------------------------::
:Run_away
echo          %name%:
echo        ==========
...
echo █         :::            Dark Cave ⛆⛆⛆⛆⛆         ⛆               █
echo █         :::                                        ⛆          █
echo █     Annville Town ███████ Forgotten forest ⛆⛆⛆⛆⛆              █
echo █                                                               █
echo █ ============================================================= █
echo █::: = Take Carriage  ███ = Foot Distance  █ = Area  ⛆ = Ocean  █
echo ██████████████████████████████████████████████████████████████████
pause >nul
goto Menu
...
:NORTH_Loading_Screen
cls
echo                                                    PLEASE WAIT...
echo.
ping localhost -n 5 >nul
if %SW1% == NO goto VillainBase_Cutscene_1
if %SW1% == YES goto NothernArea_1
...
::Enter boss one
::Boss status - also boss battle enterance
:BOSS_BATTLE1
color 0F
ping localhost -n 1 >nul
color F0
...
:VillainBase_Cutscene_1
cls
echo    ?????:
echo  ==========
echo  So he was defeated by this %name% person....
echo Then that means the are is left wide open...
echo                  (v)
pause >nul
cls    
echo  ??????????:
echo =============
echo That means that we strike the country right?
echo                  (v)
pause >nul
cls
echo    ?????:
echo  ==========
echo Yes, however, this may be more serious than we expected... 
echo This %name%... Find out as much as you can about him...
pause >nul
cls
echo   As you ride in the carriage, you look outside...
echo                    (v)
pause >nul
cls
echo                      ooooo    ooooo    ooooo
...
echo     Carrier:
echo     ========
echo     So you said your name was %name%? Well, %name% were almost at your 
echo    stop. If you have any questions just let me know them now.
echo                              (v)
pause >nul
cls
echo                      ooooo    ooooo    ooooo
...
echo     Carrier:
echo     ========
echo     Oh? None? You must really know your stuff. 
echo     Here we are. Safe travels.
echo                         (v)
pause >nul
cls
echo   Meanwhile....
...
::  -------------------------------------------------------------
rem Program made by Jones Entertainment Games - Christopher Jones
rem continued 2023-2025