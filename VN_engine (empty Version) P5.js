...
function keyPressed()
{
    ...
    */
    ...
    if (event_cutscene == true && message_code > 10) event_cutscene=false;
    if (menu_load == true) message_code += 1;
    if (menu_load == true && message_code > 11) message_code = 11;
    if (Home == true) message_code += 1;
    if (Home == true && message_code > 21) messaage_code = 12;
}
...
function draw() {
  ...
  //Items
  if (message_code == 11) message="ITEM(w) -- SAVE(s) -- EXIT MENU(d)";
  ...
  if (message_code == 1) message="";
  if (message_code == 2) message="";
  if (message_code == 3) message="";
  if (message_code == 4) message="";
  if (message_code == 5) message="";
  if (message_code == 6) message="";
  if (message_code == 7) message="";
  if (message_code == 8) message="";
  //code for naming the player is not included.
  if (message_code == 9) message="";
  if (message_code == 10) message="Press (e) for the menu...";
  ...
  //Chapter 1 
  message1=true;
  if (Home == true) textbox=true;
  if (Home == true) message_code=12;
  if (message_code == 12) message="";
  if (message_code == 13) message="";
  if (message_code == 14) message="";
  //with the message_answer variable you can decide user answers from in game.
  //by adding in switches, (Choice switches you can add events based on what is done in game.)
